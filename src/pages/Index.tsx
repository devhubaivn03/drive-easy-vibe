...
import { Bike, Car, LogIn, GraduationCap, Clock, Award, Users, Star, Heart } from "lucide-react";
import { supabase } from "@/lib/supabase";

const iconMap: Record<string, any> = { Users, GraduationCap, Clock, Award, Bike, Car, Star, Heart };
    ...
    <div className="min-h-screen bg-background grid-bg overflow-hidden">
      ...
      <nav className="fixed top-0 z-40 w-full glass-card border-b border-border/50">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <span className="text-xl font-extrabold gradient-text">🚗 {brandName}</span>
        ...
        <div className="relative z-10 flex flex-col gap-8 md:flex-row">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              {motorbikeInfo.items.map((i: any) => i.type).join(", ")} — Nhanh chóng, tiện lợi
            </p>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              {carInfo.items.map((i: any) => i.type).join(", ")} — Chuyên nghiệp, bài bản
            </p>
